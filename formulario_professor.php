<?php
    ...
    if(isset($_POST['submit'])){
        ...
        */
        ...
        $result = mysqli_query($conexao, "INSERT INTO tabela_professor(nome,cpf,email,telefone,sexo,data_nasc,cep,endereco,formacao,banco,agencia,conta) VALUES ('$nome','$cpf','$email','$telefone','$sexo','$data_nasc','$cep','$endereco','$formacao','$banco','$agencia','$conta')");
...
<body>
    <div class="box">
        <form action="formulario_professor.php" method="POST">
            <fieldset>
                <legend>
                    <b>Formulário do Professor</b>
                </legend>
