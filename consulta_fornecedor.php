        ...
        <fieldset>
            ...
            <table width="1200px" border="1">
                ...
                <?php
                    ...
                    $sql_code = "SELECT * 
                        FROM tabela_fornecedor 
                        WHERE nomeEmpresa LIKE '%$pesquisa%' 
                        or cnpj LIKE '%$pesquisa%' 
                        or email LIKE '%$pesquisa%' 
                        or telefone LIKE '%$pesquisa%' 
                        or areaAtuacao LIKE '%$pesquisa%'  
                ...
                ?>
                    ...
                    <?php } else{
                        while($dados = $sql_query->fetch_assoc()){
                            ?>
                            <tr>
                                <td><?php echo $dados['nomeEmpresa']; ?></td>
                                <td><?php echo $dados['cnpj']; ?></td>
                                <td><?php echo $dados['email']; ?></td>
                                <td><?php echo $dados['telefone']; ?></td>
                                <td><?php echo $dados['areaAtuacao']; ?></td>
